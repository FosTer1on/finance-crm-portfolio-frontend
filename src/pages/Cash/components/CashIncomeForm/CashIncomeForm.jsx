...
import { createCashIncome } from "@/api/cash";
...
import styles from "./CashIncomeForm.module.css";
...
const CashIncomeForm = forwardRef(function CashIncomeForm(
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSubmitError(
        normalized.message || "Не удалось добавить приход в кассу."
      );
    } finally {
      setSubmitting(false);
