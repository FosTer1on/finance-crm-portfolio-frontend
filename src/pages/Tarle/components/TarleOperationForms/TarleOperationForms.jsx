...
import { createTarleIncoming, createTarleOutgoing } from "@/api/tarle";
...
import TarleProductSelect from "../TarleProductSelect/TarleProductSelect";

import styles from "./TarleOperationForms.module.css";
...
function mapBackendFieldErrors(details) {
  ...
  return {
    ...
    productId: getFirstError(details.product_id),
...
export default function TarleOperationForms({
  date,
  products = [],
  ...
  async function handleIncomingSubmit() {
    ...
    try {
      ...
      showSuccess("Приход TARLE сохранён");
  ...
  async function handleOutgoingSubmit() {
    ...
    try {
      ...
      showSuccess("Исход TARLE сохранён");
      ...
      <div className={styles.forms}>
        <div className={styles.form}>
          ...
          <label className={styles.field}>
            ...
            <TarleProductSelect
              ref={incomingNavigation.registerField("product")}
              products={products}
              loading={productsLoading}
              value={incomingForm.productId}
              disabled={incomingDisabled}
              status={incomingFieldErrors.productId ? "error" : undefined}
              onKeyDown={incomingKeyDown("product")}
              onChange={(value) => {
                updateIncomingField("productId", value ?? null);
              }}
            />

            <FieldError>{incomingFieldErrors.productId}</FieldError>
          </label>
        ...
        <div className={styles.form}>
          ...
          <label className={styles.field}>
            ...
            <TarleProductSelect
              ref={outgoingNavigation.registerField("product")}
              products={products}
              loading={productsLoading}
              value={outgoingForm.productId}
              disabled={outgoingDisabled}
              status={outgoingFieldErrors.productId ? "error" : undefined}
              onKeyDown={outgoingKeyDown("product")}
              onChange={(value) => {
                updateOutgoingField("productId", value ?? null);
              }}
            />

            <FieldError>{outgoingFieldErrors.productId}</FieldError>
          </label>
